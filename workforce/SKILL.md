---
<!-- Enforcement: 3 assertion(s) in bin/check name this file; 41 normative claims total. 8 generic assertions guard it too. Coverage is a floor, not a certificate — run bin/coverage. -->
name: workforce
