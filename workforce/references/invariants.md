...
a FAIL, not a report** — companions are materialized from shipped doctrine, and *"the distribution ships
none"* is never a valid skip. `/org` specifically is generated by `org index`; its absence after the run
