...
4. **Assert five things on every write:**
   ...
   - the written `operating-principles/SKILL.md` carries the plain-output clause — anything a human
     ...
     answer it is a broken question, no reply opens with agreement, and a reversible small call is
     decided rather than asked (`references/plain-output.md`). Double-guarded here for the same
