...
**4 unknown marker families**, none in `legacy-markers.md`: `ROUTE-DISPATCH-CHECKPOINT` (5),
`CODE-EVAL-ENFORCE` (1), `CREATIVE-SCRUB-EMBED` (1), `MODEL-SWITCH-GATE` (1).
...
model (0/45), unknown marker families (4), unpaired markers (5). The numbers that should **not**:
