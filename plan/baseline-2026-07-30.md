...
| **UNPAIRED markers (sweep hazard)** | **4** |
...
- `ROUTE-DISPATCH-CHECKPOINT` — 7 occurrence(s). Not in `legacy-markers.md`; classify before any sweep.
- `CREATIVE-SCRUB-EMBED` — 2 occurrence(s). Not in `legacy-markers.md`; classify before any sweep.
- `CODE-EVAL-ENFORCE` — 2 occurrence(s). Not in `legacy-markers.md`; classify before any sweep.
